...
const IconMatch    = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M12 4v16"/><path d="M8 8h2"/><path d="M14 8h2"/><path d="M8 12h8"/></svg>

const NAV_ITEMS = [
  { key: 'home',        label: 'Home',            Icon: IconHome        },
  { key: 'profile',     label: 'Manage Profile',   Icon: IconProfile     },
  { key: 'tournaments', label: 'My Tournaments',   Icon: IconTournament  },
  { key: 'matches',     label: 'My Matches',       Icon: IconMatch       },
]
...
function RefereeSidebar({ active, onSelect, open, onToggle }) {
